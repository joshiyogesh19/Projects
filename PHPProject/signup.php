...
<body class="signuppage">
	...
	<!--<div class="container">
		<h4 style="color: cyan; font-family: verdana; margin-top: 60px;" class="intro-text">Signup to become a member and enjoy the coupons feature.</h4>
		
		<form method="POST" action="Signup.php" style="color: white;" id="signupform">
			<h3 style="color: lightgreen;" class="intro-text text-center"><strong>Member Info</strong></h3>
			<div class="form-group">
				<label for="exampleInputFirstname">First Name</label>
				<input type="text" class="form-control" name="fname" aria-describedby="firstnameHelp" placeholder="Enter firstname" required>
			</div>
			...
			<h3 style="color: lightgreen;" class="intro-text text-center"><strong>Required Login Credentials</strong></h3>
			<div class="form-group">
				<label for="exampleInputEmail">Email address</label>
				<input type="email" class="form-control" name="e-mail" aria-describedby="emailHelp" placeholder="Enter email" required>
			</div>	
			...
			<button class="btn btn-primary" type="submit" name="insert">Sign Up</button>
			<p class="para">Are you a member?<a style="color: cyan;" href="login.php">Login</a></p>
		</form>
	</div>
		...
		<!--<footer>Copyright &copy; ConnectWithUs.com 2017</footer>-->
	<!--<div>
	<h3 style="color: cyan; float: left; font-family: verdana;">Signup to become a member and enjoy the coupons feature.</h3>
	<form class="information" action="Signup.php" method="POST">
			<h3 style="color: cyan;">Member Info</h3>
			...
			<h3 style="color: cyan;">Required Login Credentials</h3>
			<input type="email" name="mail" placeholder="EMAIL"><input type="password" name="pword" placeholder="NEW PASSWORD">
			<button class="submit" name="insert">Sign Up</button>
			<p class="para">Are you a member?<a style="color: cyan;" href="login.php">Login</a></p>
	</form>
	</div>
	
	<div>
	<footer>Copyright &copy; ConnectWithUs.com</footer>
	</div>-->
