    ...
    <body>
        ...
        <form action="addLocation" method="post">
            <div class="form-inline col-md-2">
                ...
                <input class="form-control" type="text" name="locationName" id="locationName" required/>
            </div><br/>
            <div class="form-inline col-md-2">
                <label>Max # of flyers this location can have:</label>&nbsp; 
                <input class="form-control" type="number" min="0" name="distributionCapacity" id="distributionCapacity" required/>
            </div><br/>
