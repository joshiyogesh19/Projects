    ...
    <body>
        ...
        <center>
            ...
            <c:if test="${username!='admin'}">
                <a href="createOrder">Add Order</a><br/><br/>
            </c:if>
            <table class="table-striped" cellpadding="5" border="1">
                ...
                <c:forEach var="order" items="${ordersList}">
                    <tr>
                        ...
                        <td><img class="picture" src="data:image/jpg;base64,<c:out value='${order.getBase64FlyerImage()}'/>"/></td>
                        ...
                        <c:choose>
                            <c:when test="${order.isFlyerArtApproved == 1}">
                                <td>Art Work approved</td>
                            </c:when>
                            <c:otherwise>
                                <td>Not Approved</td>
                            </c:otherwise>
                        ...
                        <c:choose>
                            <c:when test="${order.isPaymentReceived == 1}">
                        ...
                        <td><a href="showEditOrder?id=<c:out value='${order.id}'/>">
                                Edit
                            </a>
                                &nbsp;&nbsp;&nbsp;
            ...
            <p style="color:red;"><c:out value="${message}">${message}</c:out></p>
        </center>
    </body>
</html>
