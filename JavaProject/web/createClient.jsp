    ...
    <body>
        ...
        <form action="addClient" method="post">
            ...
            <div class="form-inline col-md-2">
                ...
                <input class="form-control" type="text" name="stNum" id="stNum" required/>
            </div><br/>
            <div class="form-inline col-md-2">
                <label>Street Name: </label>
                <input class="form-control" type="text" name="stName" id="stName" required/>
            </div><br/>
            <div class="form-inline col-md-2">
                <label>City: </label> &nbsp;
            ...
            <div class="form-inline col-md-2">
                ...
                <input class="form-control" type="text" name="telOffice" id="telOffice" required/>
            </div><br/>
            <div class="form-inline col-md-2">
                <label>Telephone cell: </label>
                <input class="form-control" type="text" name="telCell" id="telCell" required/>
            </div><br/>
            <div class="form-inline col-md-2">
                <label>Email : </label>
            ...
            <div class="form-inline col-md-2">
                ...
                <input class="form-control" type="text" name="companyType" id="companyType" required/>
            </div><br/>
