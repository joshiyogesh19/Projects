    ...
    <body>
        ...
        <center>
            ...
            <form action="updateAgent" method="post">
                ...
                <input type="hidden" name="idOfAgent" id="idOfAgent" value="${agent.login.agentId}"/>
                <div class="form-inline col-md-2">
                    <label>First Name: </label>&nbsp;
                    <input class="form-control" type="text" name="fName" id="fName" value="${agent.firstName}" required/>
                </div><br/>
                <div class="form-inline col-md-2">
                    <label>Last Name: </label>&nbsp; 
                    <input class="form-control" type="text" name="lName" id="lName" value="${agent.lastName}" required/>
                </div><br/>
                <div class="form-inline col-md-2">
                    <label>Phone No: </label>&nbsp;&nbsp;
                    <input class="form-control" type="text" name="phoneNo" id="phoneNo" value="${agent.phoneNo}" required/>
                </div><br/>
                <div class="form-inline col-md-2">
                    <label>Email: </label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                    <input class="form-control" type="text" name="email" id="email" value="${agent.email}" required/>
                </div><br/>
                <div class="form-inline col-md-2">
                    <label>User Name: </label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                    <input class="form-control" type="text" name="userName" id="userName" value="${agent.login.userName}" required/>
                </div><br/>
                <div class="form-inline col-md-2">
                    <label>Password: </label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                    <input class="form-control" type="text" name="password" id="password" value="${agent.login.password}" required/>
                </div><br/>
