        ...
        <center> 
            ...
            <form action="addOrder" method="post">
                ...
                <div class="form-inline col-md-2">
                    ...
                    <input class="form-control" type="text" name="quantity" id="quantity" required/><br>
                </div>
                <div class="form-inline col-md-2">
                    <div class="form-group">
                ...
                <div class="form-inline col-md-2">
                    ...
                    <input class="form-control" type="text" name="cardnum" id="quantity" required/>
                </div><br/>
                <div class="form-inline col-md-2">
                    <label>Expr. Date: </label>&nbsp;
                    <input class="form-control" type="text" name="expdate" id="quantity" required/>
                </div><br/>
                <div class="form-inline col-md-2">
                    <label>CVV#: </label>&nbsp;
                    <input class="form-control" type="text" name="cvvnum" id="quantity" required/>
                </div><br/>

                <div class="form-inline col-md-2">
                    <label>Personal Copy: </label>&nbsp;
                    <input class="form-control" type="text" name="personalcopy" id="quantity" required/>
                </div><br/>
                <div class="form-inline col-md-2">
                    <div class="form-group">
                        <label for="clientselection">Client Selection: </label>&nbsp;
                        <select class="form-control" id="clientselection1" name="clientselection" required>
                ...
                <div class="form-inline col-md-2">
                    ...
                    <input class="form-control" type="text" name="comments" id="quantity" required/>
                </div><br/>
                <div class="form-group">
