    ...
    <body>
        ...
        <center>
            ...
            <table class="table-striped" cellpadding="5" border="1">
                ...
                <tbody>                
                <c:forEach var="agent" items="${objectList}">
                    <tr>
                        ...
                        <td><c:out value="${agent.login.userName}"/></td>
                        <td><a href="editAgent?id=<c:out value='${agent.id}'/>&agentId=<c:out value='${agent.login.agentId}'></c:out>">
                                Edit
                            </a>
                                &nbsp;&nbsp;&nbsp;
                            <a href="deleteAgent?id=<c:out value='${agent.id}'/>&agentId=<c:out value='${agent.login.agentId}'></c:out>">
                                Delete
                            </a>
                        </td>
                    </tr>
